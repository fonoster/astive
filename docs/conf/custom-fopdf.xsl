...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:d="http://docbook.org/ns/docbook" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
   ...
   <xsl:param name="generate.toc">book toc,figure,example</xsl:param>
   ...
   <!-- 11.00in english paper sizes DIN A4 297x210 mm -->
  ...
  <xsl:call-template name="page.sequence">
   ...
   <xsl:with-param name="content">
     <fo:block text-align="center" >
       <fo:external-graphic src="url(../guide/images/cover/cover_a4.png)" content-width="100%" />
     </fo:block>
   </xsl:with-param>
  </xsl:call-template>
 </xsl:template>
